...
const LoginScreen: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const handleLogin = async () => {
    ...
    const correctEmail = 'danu@gmail.com';
    const correctPassword = 'danu';
  ...
  const handleBiometricLogin = async () => {
    try {
      ...
      if (biometryType) {
        ...
        if (result) {
          // Use the correct hardcoded credentials for biometric login
          const correctEmail = 'danu@gmail.com';
          const correctPassword = 'danu';
          onLogin(correctEmail, correctPassword);
        }
      } else {
